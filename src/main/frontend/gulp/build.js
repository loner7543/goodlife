...
gulp.task('fonts-custom', function () {
  return gulp.src(path.join(conf.paths.src, '/app/fonts/**/*.{eot,otf,svg,ttf,woff,woff2}'))
...
gulp.task('other', function () {
  ...
  return gulp.src([
    ...
    path.join('!' + conf.paths.src, '/**/*.{html,css,scss}'), //HACK for config.js {html,css,js,scss}
